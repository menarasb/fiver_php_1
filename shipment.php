        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Shipment</h1>
                    <p class="mb-4">Shipment Data</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">
                                <a href="?page=add" class="btn btn-primary btn-icon-split">
                                    <span class="icon text-white-50">
                                        <i class="fas fa-plus"></i>
                                    </span>
                                    <span class="text">Add New Shipment</span>
                                </a>
                            </h6>
                        </div>
                        <div class="card-body">
                            ...
                            $page = $_GET['page'];
                            if ($page == 'data') {
                                include('shipment_data.php');
                            } elseif ($page == 'add') {
                                include('shipment_add.php');
                            } elseif ($page == 'edit') {
                                include('shipment_edit.php');
                            }
                            ?>
                        </div>
                    </div>
