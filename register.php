                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $query = $con->query("INSERT INTO users (username,password,name) VALUES ('$username','$password','$name')");
                                        if($query){
                                    ...
                                    <form class="user" action="" method="POST">
                                        <div class="form-group">
                                            <input type="text" name="name" class="form-control form-control-user" placeholder="Your Name..." required>
                                        </div>
                                        <div class="form-group">
